...
| Piece 并发 |    TCP |       URMA |       提升比 |
| -------: | -----: | ---------: | --------: |
|        1 | 647 ms |     460 ms | **1.41×** |
|        2 | 448 ms |     311 ms | **1.44×** |
|        4 | 405 ms |     204 ms | **1.99×** |
|        8 | 401 ms |     144 ms | **2.78×** |
|       16 | 401 ms | **135 ms** | **2.97×** |
|       32 | 403 ms |     151 ms | **2.67×** |
...
| ---------- | ---------: | ---------: | --------: |
| 代表并发       |       CC16 |       CC16 |         — |
| 1 GiB 下载时间 | **401 ms** | **135 ms** | **2.97×** |
| 吞吐         | 2553 MiB/s | 7571 MiB/s | **2.97×** |
| 约合带宽       |  21.4 Gbps |  63.5 Gbps | **2.97×** |
